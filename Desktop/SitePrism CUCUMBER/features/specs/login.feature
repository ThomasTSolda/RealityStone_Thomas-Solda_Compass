...
Funcionalidade: Login de usuário
    ...
    Esquema do Cenário: Validar o login de usuários
        ...
        |                      |12345678         |Email é obrigatório                    |
        |thomas@thomas         |12345678         |Email deve ser um email válido         |
        |thomas@thomas.com     |                 |Password não pode ficar em branco      |
        |thomas@thomas.com     |123456           |Email e/ou senha inválidos             |
        |thomas@thomas.com     |12345678         |                                       |
